            ...
            <div className="support-us">
                <div className="left-section">
                    <div className="form-wrapper">
                        <h1>Support Us</h1>
                        <p>
                            Let's join hands to eliminate blindness from Africa. We are early looking to fund and
                            improve the technology day by day.
                            <br />
                            <br />
                        ...
                        <p>
                            With a community of over 20,000 members we're continuously expanding to reach out for
                            awareness programs and free diagnosis camps across Africa!
                        </p>
                        <div className="group-wrapper">
                            <div className="white-board">
                                ...
                                <div>
                                    ...
                                    <Link href="/">facebook.com/Encocare Support Group</Link>
                                </div>
                            </div>
