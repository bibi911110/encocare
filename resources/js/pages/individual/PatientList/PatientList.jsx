...
import { crossCircleIcon, eyeIcon, filterIcon, leftArrowIcon2 } from '@/components/icons/common';
...
const TableMobileCard = ({ id, name, test, email, contact, date, time, address }) => {
    return (
